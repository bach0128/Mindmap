export default function Features() {
    return (<div className="py-4 px-6" style={{
      ...
      <div className="text-center px-40">
        ...
        <button className="text-indigo-700 text-2xl px-8 py-2 border-indigo-700 rounded mt-8 hover:bg-indigo-700 hover:text-white" style={{ border: "2px solid" }}>
          Learn more
        </button>
      </div>
      ...
      <div className="py-2 flex items-center justify-center mb-10">
        <div className="container flex items-center justify-center mt-16">
          <div className="md:w-1/3 text-center flex flex-col items-center justify-center rounded px-8 py-6 mx-4" style={{
            border: "2px solid gray",
            backgroundColor: "#D9AFD9",
            backgroundImage: "linear-gradient(0deg, #D9AFD9 0%, #97D9E1 100%)",
        }}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="true" viewBox="0 0 24 24" strokeWidth={1.5} stroke="blue" className="w-6 h-6 my-6">
          ...
          <div className="md:w-1/3 text-center flex flex-col items-center justify-center rounded px-8 py-6 mx-4" style={{
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="blue" className="w-6 h-6 my-6">
